...
public class GUIInfoConsegnaController implements Initializable {
    ...
    public void onClick(ActionEvent event){
        ...
        if (event.getSource() == firmaButton) {
            controlConsegna.onClickfirma(consegna);
        }
    }
