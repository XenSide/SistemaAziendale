...
public class GUIModificaOrdineController implements Initializable {
    ...
    public GUIModificaOrdineController(Stage stage, ControlOrdiniF controlOrdiniF, List<Ordine> listaOrdini) {
        this.stage = stage;
