...
public class GUICaricamentoNuovoProdottoController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        dataProduzioneField.setConverterSupplier(() -> new DateStringConverter("yyyy-MM-dd", dataProduzioneField.getLocale()));
        dataScadenzaField.setConverterSupplier(() -> new DateStringConverter("yyyy-MM-dd", dataScadenzaField.getLocale()));
